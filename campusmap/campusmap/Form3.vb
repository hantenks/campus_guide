...
Public Class Form1
    ...
    Public Sub New()
        ...
        'toolTip1.SetToolTip(Me.facultyHall, "Main Gate")
        ...
        'For Each l As Control In PictureBox1.Controls
        '    If TypeOf l Is Label Then
        '        locationX += l.Name + "|" + (l.Location.X).ToString + "|"
        '        locationY += l.Name + "|" + (l.Location.Y).ToString + "|"
        '    End If
        'Next l
        'File.WriteAllText("B:\XData.txt", locationX)
        'File.WriteAllText("B:\YData.txt", locationY)
    End Sub
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load    'This functions check whether the resolution is correct or not and displays a warning accordingly
        ...
        End If
        Console.WriteLine(Screen.PrimaryScreen.Bounds.ToString)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        '        label_Click(mech, e)
            ...
            label_MouseEnter(mech, e)
            label_Click(mech, e)
            Timer1.Enabled() = True

            'Thread.Sleep(5000)
            'label_MouseEnter(ac, e)




            '  label_MouseLeave(mech, e)
            'label_Click(ac, e)
            'label_MouseEnter(ac, e)
            '   Thread.Sleep(10000)

            ' label_MouseLeave(ac, e)
    End Sub
