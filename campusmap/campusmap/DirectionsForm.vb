...
Public Class DirectionsForm
    ...
    Private Function ResizeImage(ByRef imgSource As Image, ByVal sizeX As Integer, ByVal sizeY As Integer)
        'resize the image, given size of new image
    ...
    'handling mouse leave event on map
    Private Sub label_MouseLeave(sender As Object, e As EventArgs) Handles facultyHall.MouseLeave, marketComplex.MouseLeave, dblock.MouseLeave, bblock.MouseLeave, serp.MouseLeave, dblock2.MouseLeave, cblock.MouseLeave, eblock2.MouseLeave, eblock.MouseLeave, fblock1.MouseLeave, dblock3.MouseLeave, fblock2.MouseLeave, tennis.MouseLeave, subansiri.MouseLeave, hockey.MouseLeave, football.MouseLeave, fblock4.MouseLeave, fblock3.MouseLeave, athletic.MouseLeave, married.MouseLeave, aseb.MouseLeave, guestlake.MouseLeave, guesthouse.MouseLeave, watertreatment.MouseLeave, umium.MouseLeave, tc.MouseLeave, swim.MouseLeave, siang.MouseLeave, phy.MouseLeave, mech.MouseLeave, mch.MouseLeave, manas.MouseLeave, lt.MouseLeave, kv.MouseLeave, kapili.MouseLeave, kameng.MouseLeave, iitglake.MouseLeave, hss.MouseLeave, hospital.MouseLeave, environment.MouseLeave, energy.MouseLeave, eee.MouseLeave, dihing.MouseLeave, dibang.MouseLeave, dd.MouseLeave, cse.MouseLeave, cricket.MouseLeave, conference.MouseLeave, chem.MouseLeave, cet.MouseLeave, cc.MouseLeave, bt.MouseLeave, brahmo.MouseLeave, barak.MouseLeave, audi.MouseLeave, akshara.MouseLeave, admin.MouseLeave, ac.MouseLeave, mainGate.MouseLeave
        Try
            Dim caller As Label
    ...
    Private Sub label_MouseEnter(sender As Object, e As EventArgs) Handles facultyHall.MouseEnter, marketComplex.MouseEnter, dblock.MouseEnter, bblock.MouseEnter, serp.MouseEnter, dblock2.MouseEnter, cblock.MouseEnter, eblock.MouseEnter, eblock2.MouseEnter, fblock1.MouseEnter, dblock3.MouseEnter, fblock2.MouseEnter, tennis.MouseEnter, subansiri.MouseEnter, hockey.MouseEnter, football.MouseEnter, fblock4.MouseEnter, fblock3.MouseEnter, athletic.MouseEnter, married.MouseEnter, aseb.MouseEnter, guestlake.MouseEnter, guesthouse.MouseEnter, watertreatment.MouseEnter, umium.MouseEnter, tc.MouseEnter, swim.MouseEnter, siang.MouseEnter, phy.MouseEnter, mech.MouseEnter, mch.MouseEnter, manas.MouseEnter, lt.MouseEnter, kv.MouseEnter, kapili.MouseEnter, kameng.MouseEnter, iitglake.MouseEnter, hss.MouseEnter, hospital.MouseEnter, environment.MouseEnter, energy.MouseEnter, eee.MouseEnter, dihing.MouseEnter, dibang.MouseEnter, dd.MouseEnter, cse.MouseEnter, cricket.MouseEnter, conference.MouseEnter, chem.MouseEnter, cet.MouseEnter, cc.MouseEnter, bt.MouseEnter, brahmo.MouseEnter, barak.MouseEnter, audi.MouseEnter, akshara.MouseEnter, admin.MouseEnter, ac.MouseEnter, mainGate.MouseEnter
        Try
            ...
            curloc.Y = caller.Location.Y - (TOOLTIP_SIZE) / 4
            caller.Location = curloc
            Label5.Text = "Current Location: " + vbNewLine + StrConv(GetData(caller.Name, 3), VbStrConv.ProperCase) 'Current item is displayed in the rich textbox
        ...
        End Try
    End Sub
    'function to get data about the locations on the map
    Private Function GetData(caller As String, mode As Integer) As String
        ...
        End If
    End Function
    'function to extract image from resources based on label name
    Private Function GetImage(caller As String) As Image
    ...
    Private Sub SetLabelParents()
        ...
        guesthouse.Parent = PictureBox1
        ' mainGate.Location = a
        mainGate.Image = ResizeImage(GetImage("mainGate"), 10, 10)
    End Sub

    'function to perform appropriate form processing on clicking label
    Private Sub label_Click(sender As Object, e As EventArgs) Handles guestlake.Click, mainGate.Click, watertreatment.Click, umium.Click, tennis.Click, tc.Click, swim.Click, subansiri.Click, siang.Click, serp.Click, phy.Click, mech.Click, mch.Click, married.Click, marketComplex.Click, manas.Click, lt.Click, kv.Click, kapili.Click, kameng.Click, iitglake.Click, hss.Click, hospital.Click, hockey.Click, guesthouse.Click, football.Click, fblock4.Click, fblock3.Click, fblock2.Click, fblock1.Click, facultyHall.Click, environment.Click, energy.Click, eee.Click, eblock2.Click, eblock.Click, dihing.Click, dibang.Click, dd.Click, dblock3.Click, dblock2.Click, dblock.Click, cse.Click, cricket.Click, conference.DoubleClick, chem.Click, cet.Click, cc.Click, cblock.Click, bt.Click, brahmo.Click, bblock.Click, barak.Click, audi.Click, athletic.Click, aseb.Click, akshara.Click, admin.Click, ac.Click
        Try
            Dim caller As Label = CType(sender, Label)
            If formState = 0 Then
                TextBox1.Text = GetData(caller.Name, 3) + ", IIT Guwahati, Guwahati, Assam 781039"
                Label4.Text = "Select a destination on the map to the right"
                formState += 1
            ElseIf formState = 1 Then
                TextBox2.Text = GetData(caller.Name, 3) + ", IIT Guwahati, Guwahati, Assam 781039"
                If TextBox2.Text = TextBox1.Text Then
                    MsgBox("Please choose different source and destination")
                    TextBox2.Text = ""
                Else
                    Label4.Text = "Click on the 'Get Directions' button to get directions and on the 'Reset' button to reset"
                    formState += 1
                    Button2.Enabled = True
                End If
            Else
                MsgBox("Please complete current transaction or reset the form", MsgBoxStyle.Exclamation, "Error")
            End If
        Catch ex As Exception
            MsgBox("An unexpected technical error occured [LabelClick]..." + vbNewLine + ex.ToString)
        End Try

    End Sub

    'appropriate checking of environment
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        End If
        MsgBox("Warning: Internet Connectivity required for proper functionality", MsgBoxStyle.Exclamation, "Get Directions: Warning")
    End Sub

    'Help button functiom
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim t As String = "Click on the source location in the map. CLick on the destination location in the map. Click on the 'Get Directions' Button to get directions.Reset and use repeatedly."
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Label4.Text = "Select a source on the map to the right"
    End Sub
    ...
    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles Button2.Click
        formState = 0
        Button2.Enabled = False
        'conversion of search text to appropriate structure for direct URL web searching
        Dim v() As String = TextBox1.Text.Split(" ")
        Dim u() As String = TextBox2.Text.Split(" ")
        Dim t = "", w = ""
        ...
        For Each s As String In u
            w += ("+" + s)
        Next s
        WebBrowser1.Navigate("https://www.google.co.in/maps/dir/" + t + "/" + w + "/")
    End Sub
End Class
